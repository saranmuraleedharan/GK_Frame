...
/*---------------Send to OPEX-----------------*/
	...
	{
		inopsappBTN.click();
		inopstxtBOX.sendKeys("Approved SrefnoIPBuccessfully");
		Thread.sleep(1000);
		sfapprBTN.click();
...
/*--------------------Settlement related Methods----------------------------*/
    ...
    public void Settle_Nominee() throws AWTException, InterruptedException
    {
		...
		calsetBTN1.click();
		Thread.sleep(1000);
		dcvfupBTN.sendKeys("/home/i-exceed.com/saran.muraleedharan/WORK/Framework/GK_Frame/Files/DischargeVoucher.pdf");
		Thread.sleep(1000);
		appOK.click();
		Thread.sleep(1000);
		popOK.click();
